...
<body>
                        ...
                        <tbody>
                            ...
                            <?php if ($lv && mysqli_num_rows($lv) > 0): while ($row = mysqli_fetch_assoc($lv)): ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm" onclick="showEditForm(<?php echo (int)$row['streaming_id']; ?>, '<?php echo htmlspecialchars(addslashes($row['judul'])); ?>', '<?php echo htmlspecialchars(addslashes($row['url'])); ?>', '<?php echo htmlspecialchars($row['tipe']); ?>')">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editLiveForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Tipe</label>
                    <select name="tipe" id="editLiveTipe"><option value="youtube">YouTube (embed)</option><option value="mp4">MP4 (upload)</option></select>
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        function showEditForm(id, judul, url = '', tipe = '') {
